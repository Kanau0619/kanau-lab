      ...
      <main>
        <section className="home-hero container">
          <div className="home-hero__main">
            ...
            <p>
              从 Persona、关系与信息边界，到 Prompt 迭代、状态设计和多模型测试。
              这里记录我如何把角色概念拆成可运行、可测试、可复盘并持续迭代的 AI 交互体验。
            </p>
        ...
        <section className="projects container" id="case-studies">
          <header className="projects__header">
            ...
            <p>
              四个项目分别聚焦高需求主动型角色控制、变量驱动交互、长期信息边界与沉浸式界面迭代。每个案例都保留真实的设计取舍、测试方法和已知限制。
            </p>
          </header>
